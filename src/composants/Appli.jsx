...
import TrierDossier from './TrierDossier';
...
export default function Appli() {
  ...
  // etat du tri des dossiers
  const triSelec = useState(['datemodif','desc']);
        ...
        utilisateur ?
          <>
            ...
            <section className="contenu-principal">
              <TrierDossier triSelec={triSelec} />
              <ListeDossiers utilisateur={utilisateur} etatDossiers={etatDossiers} triSelec={triSelec} />
